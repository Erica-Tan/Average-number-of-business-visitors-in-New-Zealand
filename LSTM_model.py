...
train_size = int(len(supervised_values) * 0.60)
train, validation = supervised_values[0:train_size], supervised_values[train_size:]
...
# walk-forward validation on the validation data
predictions = list()
